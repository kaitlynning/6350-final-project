    ...
    return new Scaffold(
      ...
      appBar: new AppBar(
        ...
        actions: <Widget>[
          new FlatButton(
            onPressed: (){
              Navigator.of(context).pushNamedAndRemoveUntil(LoginSignupPage.routeName, (Route<dynamic> route) => false);
            },
            child: Text(
              "Log Out",
              style: TextStyle(
  ...
  Widget build(BuildContext context) {
    ...
    return new FloatingActionButton(
        ...
        onPressed: () {
          ...
          Navigator.of(context).pushNamed(PostAddPage.routeName);
        }
    );
  }
}
...
//  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: new AppBar(
        title: new Text("PostDetail", style: new TextStyle(color: Colors.white)),
      ),
